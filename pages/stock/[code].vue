...
export default {
    ...
    methods: {      
        ...
        async loadData() {
            ...
            const { data } = await useFetch(`https://script.google.com/macros/s/AKfycbzbf9GXDIv09Ers2Y2AJh-MTstppmeMK9zuoGkou3hacyS2Rg75zRer0VZzZS1_WZ6z/exec?code=${c}`, { server: false })
