...
export default {
    ...
    methods: {
        ...
        async loadData() {
            ...
            const { data } = await useFetch(`https://script.google.com/macros/s/AKfycbxHnJ4zzHLkwcHbuYLsG8CtS6R4PFZhOa3o1OfvdzKCTy19Y3XuzpGewZ6hylWe5oDZ/exec?code=${c}`, { server: false })
